...
library(RPostgreSQL)
```
# Geração de relatórios com RMarkdown - Aula 4
...
## O que é? E por que usar?
  ...
  - Com o RMarkdown podemos gerar:
    + Apresentações
    + Word
    + PDF (para artigos, recomendo o uso do Knitr, com LaTeX)
    + HTML
  - Facilidade com versionamento de código (espero abordar em cursos futuros)
...
## Capítulos e seções
  ...
  - \# Capítulo (equivalente ao h1 em html)
  - \#\# Seção (equivalente ao h2 em html)
  - \#\#\# Sub-seção (equivalente ao h3 em html)
